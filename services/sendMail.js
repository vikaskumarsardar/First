  ...
  try {
    ...
    if (route === "forgetPassword") {
      ...
      html = `<h1 style="text-align:left; color:#00b9ee;">Reset your password</h1>
                    ...
                    <a style="text-decoration:none;color:#fff;font-size:15px;"href="${process.env.HEROKU_USER_ROUTE}/forgetPassword/${emailString}">Reset your password</a></div>
                    <br><br>
                    <p style="text-align:left;color:#000; font-size: 14px;">
                    <h4>Thanks,</h4>
                    <h4>Cart Team</h4>
      ...
      html = `<h1 style="text-align:left; color:#00b9ee;">Welcome To Shopping Cart</h1>
                    ...
                    <br><div style="display:inline-block;background:#00b9ee; padding:10px;-webkit-border-radius: 10px; -moz-border-radius: 4px; border-radius: 4px;">
                    <a style="text-decoration:none;color:#fff;font-size:15px;"href="${process.env.HEROKU_USER_ROUTE}/verifyUser/${emailString}">Activate Your Account</a></div>
                    <br><br>
                    <p style="text-align:left;color:#000; font-size: 14px;">    
                    <h4>    Thanks,</h4>
                    <h4>Cart Team</h4>
